...
class Actor(nn.Module):
    ...
    def __call__(self, current_state: mx.array, temporal_state: mx.array) -> mx.array:
        ...
        Args:
            current_state: (batch, 31) current features
            temporal_state: (batch, history_len * 31) stacked history
        """
...
class RLStrategy(Strategy):
    ...
    def __init__(
        self,
        input_dim: int = 31,  # v7.5: 31 features (matches MarketState.to_features)
